...
define(["require", "exports", "WoltLabSuite/Core/Ajax/Backend", "WoltLabSuite/Core/Api/Result"], function (require, exports, Backend_1, Result_1) {
    ...
    exports.updateAttendee = void 0;
    async function updateAttendee(attendeeId, distributionId, status) {
        try {
            await (0, Backend_1.prepareRequest)(`${window.WSC_API_URL}index.php?api/rpc/rp/attendees/${attendeeId}`)
                .post({
                distributionId,
                status,
            })
