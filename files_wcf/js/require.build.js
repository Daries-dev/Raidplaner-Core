(function () {
	...
	config = {
		name: "Daries/_Meta",
		out: "Daries.RP.min.js",
		useStrict: true,
		preserveLicenseComments: false,
		optimize: "none",
		excludeShallow: ["Daries/_Meta"],
		rawText: {
			"Daries/_Meta": "define([], function() {});",
		},
	...
	require._isSupportedBuildUrl = function (url) {
		...
		if (
			Object.keys(config.rawText)
				.map(function (item) {
					return (process.cwd() + "/" + item + ".js").replace(/\\/g, "/");
				})
				.indexOf(url.replace(/\\/g, "/")) !== -1
		)
			return result;
