...
final class CreateAttendee implements IController
{
    ...
    {
        $objectTypeID = ObjectTypeCache::getInstance()->getObjectTypeIDByName('dev.daries.rp.event.controller', 'dev.daries.rp.event.controller.raid');
