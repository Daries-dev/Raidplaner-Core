...
namespace rp\system\endpoint\controller\rp\events;
...
final class AvailableCharacters implements IController
{
    ...
    {
        $objectType = ObjectTypeCache::getInstance()->getObjectTypeIDByName('dev.daries.rp.event.controller', 'dev.daries.rp.event.controller.raid');
