 ...
 * @property-read   string  $title      title of the classification or name of language item which contains the title
 ...
 */
final class Classification extends DatabaseObject implements ITitledObject
{
    /**
     * Returns game object.
     */
